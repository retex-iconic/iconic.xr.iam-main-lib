...
public class AnagAttributiUtentiAggregateGetByIdQuery {

    private String anagAttributiUtentiId;

    public AnagAttributiUtentiAggregateGetByIdQuery(@JsonProperty("anagAttributiUtentiId") String anagAttributiUtentiId) {
